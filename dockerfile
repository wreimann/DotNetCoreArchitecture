# .NET Core SDK
FROM mcr.microsoft.com/dotnet/core/sdk:3.1-alpine AS dotnetcore-sdk
...
# Angular
FROM node:13.2.0-alpine AS angular-build
...
FROM mcr.microsoft.com/dotnet/core/aspnet:3.1-alpine AS aspnetcore-runtime
